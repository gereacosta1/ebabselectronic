  ...
  return (
    <section id="nosotros" className="pt-10 pb-24 bg-[#f5f7ff]">
      <div className="container mx-auto px-4">
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center gap-3 px-4 py-7">
                <div className="relative">
                  <div className="h-12 w-12 rounded-full bg-violet-100 flex items-center justify-center ring-4 ring-violet-100 group-hover:ring-violet-300/80 transition-all duration-300">
        ...
        {/* LOCATION (sin imagen ahora) */}
        <div className="mt-20">
          <div className="rounded-3xl bg-gradient-to-r from-purple-700 via-purple-600 to-fuchsia-600 text-white px-6 py-10 md:px-10 md:py-12 shadow-2xl">
            ...
            <p className="mt-3 text-sm md:text-base text-purple-50/90 max-w-xl">
              {t("about.location.p2.pre")}{" "}
              <strong>{t("about.location.p2.address")}</strong>.{" "}
